...
if fl is not None:
    ...
    os.chdir(r"C:\Users\SHANMUKHI\Documents\MYSELF\PYTHON")
...
if not region and not state and not city:
    ...
    filtered_df=df3=df3[df["State"].isin(state) & df3["City"].isin(city)]
elif region and city:
    filtered_df=df3=df3[df["Region"].isin(region) & df3["City"].isin(city)]
elif region and state:
    filtered_df=df3=df3[df["Region"].isin(region) & df3["State"].isin(state)]
elif city:
